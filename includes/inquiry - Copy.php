...
<div class="welcome">
  ...
  <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="txtTripName" class="text" value="<?php echo $_POST['txtTripName']; ?>" /></td>
    </tr>
    
    <tr>
      <td width="30%">Name <span class="red">*</span> <br /><span class="inquiry_sub">Add your name</span></td>
      <td><input type="text" name="txtname" class="text" value="<?php echo $_POST['txtname']; ?>" /></td>
    </tr>
    <tr>
      <td class="npText">Email <span class="red">*</span> <br /><span class="inquiry_sub">Add a valid address</span></td>
      <td><input type="text" name="txtemail" class="text" value="<?php echo $_POST['txtemail']; ?>" /></td>
    </tr>
    <tr>
      <td class="npText">Telephone <span class="red">*</span> <br /><span class="inquiry_sub">Number only</span></td>
      <td><input type="text" name="txtphone" class="text" value="<?php echo $_POST['txtphone']; ?>" /></td>
    </tr>
    
    <tr>
      <td>Country <br /><span class="inquiry_sub">Add your country</span></td>
      <td><input type="text" name="txtcountry" class="text" value="<?php echo $_POST['txtcountry']; ?>" /></td>
    </tr>
    <tr>
