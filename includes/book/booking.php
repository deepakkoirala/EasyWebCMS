    ...
    <div class="wel_bdy_txt">
      ...
      <table width="100%" border="0" cellspacing="4" cellpadding="0">
        <tbody>
          ...
          <tr>
            <td align="right">Trip Package Name <span class="red">*</span></td>
            <td colspan="4" align="left"><textarea name="txt_tpname" cols="35" rows="1" id="txt_tpname" tooltiptext="Type in your Trip Package name in this box"><?php echo $row['name']; ?></textarea></td>
          </tr>
          <tr>
            <td align="right">Numbers in Party</td>
            <td colspan="4" align="left"><select name="sel_adult">
          ...
          <tr>
            <td align="right">Arrival Date <span class="red">*</span></td>
            <td colspan="4" align="left"><input name="txt_adate" id="txt_adate" type="text">
              <a href="javascript:NewCal('txt_adate','yyyymmdd')" title="Select Arrival Date"><img src="images/cal.gif" alt="Select Arrival Date" border="0" height="16" width="16" align="absmiddle"></a> Format: yyyy-mm-dd</td>
          </tr>
          <tr>
            <td align="right">Flight Name/ Number</td>
            <td colspan="4" align="left"><input name="txt_flight" id="txt_flight" type="text"></td>
          </tr>
          <tr>
            <td align="right">Airport Pickup</td>
            <td colspan="4" align="left"><input name="rbtn_pickup" value="Yes" checked="checked" type="radio">
              Yes 
              <input name="rbtn_pickup" value="No" type="radio">
              No</td>
          </tr>
          <tr>
            <td align="right">Departure Date</td>
            <td colspan="4" align="left"><input name="txt_ddate" id="txt_ddate" type="text">
              <a href="javascript:NewCal('txt_ddate','yyyymmdd')" title="Select Departure Date"><img src="images/cal.gif" alt="Select Departure Date" border="0" height="16" width="16" align="absmiddle"></a> Format: yyyy-mm-dd</td>
          </tr>
          <tr>
            <td align="right" valign="top">How did you find us?</td>
            <td colspan="4" align="left"><input name="rbtn_findus" value="Client Referral" type="radio">
              Client Referral 
              <input name="rbtn_findus" value="By Web Search" type="radio">
              By Web Search</td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="right"> </td>
            <td colspan="4"><input name="btnBooking" id="btn_submit" value="Submit" type="submit">
