...
$to = "info@supporthumanresources.com";
$subject = "Uploaded from website. Biodata of ".$name;
$headers = "MIME-Version: 1.0" . "\r\n";
$headers .= "<tr><td>Content-type:text/html; charset=utf-8" . "\r\n";
$headers .= 'From: <'.$email.'>' . "\r\n";
$headers .= 'Cc: info@supporthumanresources.com' . "\r\n";
if(empty($albumcover)){
...
$message .= "<tr><td>File : <a href='http://supporthumanresources.com/$target2' target=\"_new\"> Download </a>"; 
...
$language_written_hindi = $_POST['ewritten'];
...
$headers .= 'From: <'.$email.'>' . "\r\n";
$headers .= 'Cc: info@supporthumanresources.com' . "\r\n";
$message = "First Name :</td><td>". $fname. "</td></tr>";
$message .= "<tr><td>Middle Name :</td><td>". $mname. "</td></tr>";
$message .= "<tr><td>Last Name :</td><td>". $lname. "</td></tr>";
$message .= "<tr><td>Date of Birth :</td><td>". $dob_day ." ". $dob_month. " ".$dob_year. "</td></tr>";
$message .= "<tr><td>Gender :</td><td>". $sex. "</td></tr>";
$message .= "<tr><td>Father's Name :</td><td>". $father_name. "</td></tr>";
$message .= "<tr><td>Mother's Name :</td><td>". $mother_name. "</td></tr>";
$message .= "<tr><td>Religion :</td><td>". $religion. "</td></tr>";
$message .= "<tr><td>Nationality :</td><td>". $nationality. "</td></tr>";
$message .= "<tr><td>Passport No. :</td><td>". $passport_no. "</td></tr>";
$message .= "<tr><td>Passport Valid Till :</td><td>". $passport_valid. "</td></tr>";
$message .= "<tr><td>Contact Address :</td><td>". $address. "</td></tr>";
$message .= "<tr><td>Country :</td><td>". $country. "</td></tr>";
$message .= "<tr><td>Phone :</td><td>". $phone. "</td></tr>";
$message .= "<tr><td>Email :</td><td>". $email. "</td></tr>";
$message .= "<tr><td>Occupation :</td><td>". $occupation. "</td></tr>";
$message .= "<tr><td>Academic Qualification :</td><td>". $qualification. "</td></tr>";
$message .= "<tr><td>Trainings :</td><td>". $trainings. "</td></tr>";
$message .= "<tr><td>Work Experience :</td><td>". $experience. "</td></tr>";
$message .= "<tr><td>Languages :</td><td>". "</td></tr>";
$message .= "<tr><td>Hindi Spoken :</td><td>". $language_spoken_hindi. "<br /> Hindi Written :</td><td>".$language_written_hindi. "</td></tr>" ;
$message .= "<tr><td>English Spoken :</td><td>". $language_spoken_english. "<br /> English Written :</td><td>".$language_written_english. "</td></tr>" ;
$message .= "<tr><td>Arabic Spoken :</td><td>". $language_spoken_arabic. "<br /> Arabic Written :</td><td>".$language_written_arabic. "</td></tr>" ;
$message .= "<tr><td>Expected Salary :</td><td>". $salary. "</td></tr>";
$message .= "<tr><td>Extra Information :</td><td>". $information. "</td></tr>";

$_SESSION['message']=$message;
?>
<a href="" onclick="popitup('print.php')">Print This</a>
<?php

if(mail($to,$subject,$message,$headers))
{echo "Thank you, <b>".$name."</b> for your enquiry. We will contact you at our earliest ";
}
}
...
<div class="welcome">
  <div class="wel_head">
    <div class="testi_txt">Apply Online</div>
    </div>
...
<tr><td align="right">Name</td><td><input name="txt_name" type="text" value="<?php echo $name; ?>" /></tr>
<tr><td align="right">Email Address</td><td><input name="txt_email" type="text" value="<?php echo $email; ?>" /></tr>
<tr><td align="right">Phone No.</td><td><input name="txt_phone" type="text" value="<?php echo $phone; ?>" /></tr>
<tr><td align="right">Attach Biodata</td><td><input name="resume" type="file" id="resume" /><br />
...
<div class="tabform">Apply Online </div>
<div class="error"><?php echo $error; ?>&nbsp;</div>
              ...
              <table width="95%" cellspacing="0" cellpadding="2" border="0" class="online" style="border-collapse:collapse;" >
                ...
                <tr valign="top"> 
                  ...
                  <td>&nbsp;</td>
                  <td valign="middle" class="formtext" colspan="3"><input name="qemail" type="text" class="bodysmallgrey" id="pemail" value="<?php echo $email; ?>" maxlength="20"></td>
                </tr>
                <tr valign="top">
                  <td height="26">&nbsp;</td>
